...
## 4. Revert any patches and hot fixes on the current installation
...
### Remove Orchestration Pipeline Hot fix 1
...
### Remove IKC 5.2.0 Connectivity Patch
...
### Remove Day0 Patch for IBM Software Hub
...
After all patches have been removed, proceed with the next steps
...
IBM Knowledge Catalog - The sample YAML content uses the default values:
...
Wait for the configmaps to be regenerated:
