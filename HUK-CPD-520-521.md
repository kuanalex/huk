...
```
const pool = new Pool({ connectionString: "{postgresql://postgres:3rXW92qYlztGRHnUwswOf3pjVpEkc6hNrgJ8bHmCnBuHzlOYZc7WJfB20vsolDq2@ccs-jobs-postgres-rw.cpd-instance:5432/jobsapi}" });
```
