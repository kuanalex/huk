...
### Remove DataStage Patch 4 (automatic removal)
...
### Remove IKC 5.2.0 Connectivity Patch (automatic removal)
...
### Remove CCS 5.2.0 Hot fix (automatic removal)
...
## 5. Upgrade shared cluster components (ibm-cert-manager,ibm-licensing) (est. 1-2 minutes)
