...
***Potential Issue During CCS Custom Resource Upgrade*** - [PostgreSQL cluster replicas get out of sync](https://www.ibm.com/docs/en/cloud-paks/cp-data/5.0.x?topic=platform-postgresql-cluster-replicas-get-out-sync)
...
Continue with the WKC upgrade next
